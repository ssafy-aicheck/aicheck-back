...
public class JwtProvider {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new BusinessException(BusinessErrorCodes.INVALID_JWT_SIGNATURE);
        } catch (MalformedJwtException e) {
            throw new BusinessException(BusinessErrorCodes.MALFORMED_JWT);
        } catch (ExpiredJwtException e) {
            throw new BusinessException(BusinessErrorCodes.EXPIRED_JWT);
        } catch (UnsupportedJwtException e) {
            throw new BusinessException(BusinessErrorCodes.UNSUPPORTED_JWT);
        } catch (IllegalArgumentException e) {
            throw new BusinessException(BusinessErrorCodes.ILLEGAL_JWT);
        }
    }
