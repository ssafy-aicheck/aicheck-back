...
echo "[Init] MYSQL_USER=${MYSQL_USERNAME}"
...
mysql -u root -p"${MYSQL_ROOT_PASSWORD}" <<-EOSQL
  ...
  GRANT ALL PRIVILEGES ON alarm.* TO '${MYSQL_USERNAME}'@'%';
  GRANT ALL PRIVILEGES ON bank.* TO '${MYSQL_USERNAME}'@'%';
  GRANT ALL PRIVILEGES ON batch.* TO '${MYSQL_USERNAME}'@'%';
  GRANT ALL PRIVILEGES ON business.* TO '${MYSQL_USERNAME}'@'%';
  GRANT ALL PRIVILEGES ON chatbot.* TO '${MYSQL_USERNAME}'@'%';
